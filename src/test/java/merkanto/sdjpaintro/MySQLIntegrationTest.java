...
import merkanto.sdjpaintro.domain.BookNatural;
import merkanto.sdjpaintro.domain.BookUuid;
...
import merkanto.sdjpaintro.repositories.*;
...
@DataJpaTest
@ComponentScan(basePackages = {"merkanto.sdjpaintro.bootstrap"})
